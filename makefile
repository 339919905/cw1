...
EXE    = pgmEcho pgmb2a pgma2b pgmComp pgmReduce
...
pgmEcho: pgmEcho.o pgmBase.o
	$(CC) $(CCFLAGS) $^ -o $@

pgmb2a: pgmb2a.o pgmBase.o
	$(CC) $(CCFLAGS) $^ -o $@

pgma2b: pgma2b.o pgmBase.o
	$(CC) $(CCFLAGS) $^ -o $@

pgmComp: pgmComp.o pgmBase.o
	$(CC) $(CCFLAGS) $^ -o $@

pgmReduce: pgmReduce.o pgmBase.o
	$(CC) $(CCFLAGS) $^ -o $@
